        ...
        <div id="layoutSidenav_content">
            <main class="container mt-5 mb-5">
                ...
                <form id="frmPropiedad" class="w-40 m-auto" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="">
                                <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Usuario" value="<?php echo $_SESSION['id'] ?>" readonly hidden>
                    </div>
                        <br>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" class="form-control" name="imagen[]" id="imagen" placeholder="imagen" multiple required>
                    </div>
                    <br>
                    <div class="col-md-6">
                        <div class="form-group">
