            ...
            <main class="container mt-5 mb-5">
                ...
                <form id="frmUsuario" class="w-40 m-auto" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="cedula" id="cedula" placeholder="Usuario">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="numWha" id="numWha" placeholder="Numero de telefono">
