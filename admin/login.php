...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Login || Tu Inmueble S.A">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta property="og:title" content="Tu Inmueble S.A">
    <meta property="og:type" content="Login de Tu Inmueble S.A">
            ...
            <div class="wrap-login">
                <form action="" method="POST" class="login-form validate-form" id="formLogin" autocomplete="off">
                    ...
                    <div class="wrap-input100">
                        <input type="text" placeholder="Usuario" name="cedula" value="<?php echo $username; ?>" required class="input100">
                ...
                <p class="textt"><a class="textt" href="../index.php">Principal</a></p>
            </div>
        </div>
